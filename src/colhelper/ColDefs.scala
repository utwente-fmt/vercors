...
object ColDefs {
  ...
  /** The different kinds of declaration that exist, as well as a mapping to
    * their corresponding default scope.
    */
  ...
  val DECLARATION_NAMESPACE: Map[String, Seq[String]] = Map(
    ...
    "Variable" -> Seq(
      ...
      "Scope",
      "SignalsClause",
      "RangedForLoop", // Explicit declarations
      "AxiomaticDataType",
      "JavaClass",
      "JavaInterface", // Type arguments
      "Predicate",
      "InstancePredicate", // Arguments
      "ModelProcess",
      "ModelAction",
      "ADTFunction",
      ...
      "Let",
      "ScopedExpr",
      "ForPerm", // Binders in expressions
    ),
    "LabelDecl" -> Seq(
      "Function",
      "Procedure",
    ...
    "CLocalDeclaration" ->
      Seq("CGlobalDeclaration", "CFunctionDefinition", "Scope"),
    "CParam" -> Seq("CGlobalDeclaration", "CFunctionDefinition"),
    "CPPLocalDeclaration" ->
      Seq("CPPGlobalDeclaration", "CPPFunctionDefinition", "Scope"),
    "CPPParam" -> Seq("CPPGlobalDeclaration", "CPPFunctionDefinition"),
    "JavaLocalDeclaration" -> Seq("JavaConstructor", "JavaMethod", "Scope"),
