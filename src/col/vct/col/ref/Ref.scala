...
trait Ref[G, Decl <: Declaration[G]] {
  ...
  def asTransmutable[Decl2[_] <: Declaration[_]](
      implicit witness: Decl <:< Decl2[G]
...
object Ref {
  ...
  class TransmutableRef[G, Decl[_] <: Declaration[_]](decl: => Decl[G]) {
    def asRegular[Decl2 <: Declaration[G]](
        implicit witness: Decl[G] <:< Decl2,
        tag: ClassTag[Decl2],
  ...
  def transmute[Pre, Post, Decl[_] <: Declaration[_], DPre <: Declaration[
    Pre
  ], DPost <: Declaration[Post]](ref: Ref[Pre, DPre])(
      implicit w1: DPre <:< Decl[Pre],
      w2: Decl[Post] <:< DPost,
      tag: ClassTag[DPost],
  ): Ref[Post, DPost] =
