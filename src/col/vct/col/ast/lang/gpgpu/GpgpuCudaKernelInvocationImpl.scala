...
import vct.col.ast.ops.GpgpuCudaKernelInvocationOps

trait GpgpuCudaKernelInvocationImpl[G] extends GpgpuCudaKernelInvocationOps[G] { this: GpgpuCudaKernelInvocation[G] =>
