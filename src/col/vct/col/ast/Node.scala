...
final case class ConstructorInvocation[G](ref: Ref[G, Constructor[G]], args: Seq[Expr[G]], outArgs: Seq[Expr[G]], typeArgs: Seq[Type[G]], givenMap: Seq[(Ref[G, Variable[G]], Expr[G])], yields: Seq[(Expr[G], Ref[G, Variable[G]])])(val blame: Blame[InvocationFailure])(implicit val o: Origin) extends AnyMethodInvocation[G] with ConstructorInvocationImpl[G]
...
final case class LLVMGlobalVariable[G](variable_type: Type[G], value: Option[Expr[G]], constant: Boolean)
                                      (implicit val o: Origin) extends GlobalDeclaration[G] with LLVMGlobalVariableImpl[G]
...
final case class LLVMAllocA[G](allocationType: Type[G], numElements: Expr[G])
                              (implicit val o: Origin) extends LLVMExpr[G] with LLVMAllocAImpl[G]
...
final case class LLVMSignExtend[G](inputType: Type[G], outputType: Type[G], value: Expr[G])
                                  (implicit val o: Origin) extends LLVMExpr[G] with LLVMSignExtendImpl[G]

final case class LLVMZeroExtend[G](inputType: Type[G], outputType: Type[G], value: Expr[G])
                                  (implicit val o: Origin) extends LLVMExpr[G] with LLVMZeroExtendImpl[G]

final case class LLVMTruncate[G](inputType: Type[G], outputType: Type[G], value: Expr[G])
                                (implicit val o: Origin) extends LLVMExpr[G] with LLVMTruncateImpl[G]

final class LLVMGlobalSpecification[G](val value: String)(implicit val o: Origin) extends GlobalDeclaration[G] with LLVMGlobalSpecificationImpl[G] {
  var data: Option[GlobalDeclaration[G]] = None
}

@family sealed trait LLVMMemoryOrdering[G] extends NodeFamily[G] with LLVMMemoryOrderingImpl[G]

final case class LLVMMemoryNotAtomic[G]()(implicit val o:Origin) extends LLVMMemoryOrdering[G] with LLVMMemoryNotAtomicImpl[G]
final case class LLVMMemoryUnordered[G]()(implicit val o:Origin) extends LLVMMemoryOrdering[G] with LLVMMemoryUnorderedImpl[G]
final case class LLVMMemoryMonotonic[G]()(implicit val o:Origin) extends LLVMMemoryOrdering[G] with LLVMMemoryMonotonicImpl[G]
final case class LLVMMemoryAcquire[G]()(implicit val o:Origin) extends LLVMMemoryOrdering[G] with LLVMMemoryAcquireImpl[G]
final case class LLVMMemoryRelease[G]()(implicit val o:Origin) extends LLVMMemoryOrdering[G] with LLVMMemoryReleaseImpl[G]
final case class LLVMMemoryAcquireRelease[G]()(implicit val o:Origin) extends LLVMMemoryOrdering[G] with LLVMMemoryAcquireReleaseImpl[G]
...
final case class LLVMPointerValue[G](value: BigInt)(implicit val o: Origin) extends ConstantInt[G] with LLVMExpr[G] with LLVMPointerValueImpl[G]
...
@scopes[LabelDecl] final class PVLConstructor[G](val contract: ApplicableContract[G], val args: Seq[Variable[G]], val body: Option[Statement[G]])(val blame: Blame[ConstructorFailure])(implicit val o: Origin) extends PVLClassDeclaration[G] with PVLConstructorImpl[G]
