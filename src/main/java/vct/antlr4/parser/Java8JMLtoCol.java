...
*/
public class Java8JMLtoCol extends Java8JMLBaseVisitor<ASTNode> {
  public static ProgramUnit convert_tree(ParseTree tree, String file_name, CommonTokenStream tokens, Java8JMLParser parser) {
    return null;
  }

  public static TempSequence convert_seq(ParseTree tree, String embedded_comments, CommonTokenStream tokens, Java8JMLParser parser) {
    return null;
  }
