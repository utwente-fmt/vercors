...
//      case e: OperatorExpression => e.operator match {
//        case StandardOperator.LT if e.second.equals(itervar) =>
//          cb.appendInvariant(rewrite(e))
//          lowerbounds ++= Set(create.expression(StandardOperator.Plus, e.first, create.constant(1))) // Lowerbound
//        case StandardOperator.LTE if e.second.equals(itervar)=>
//          if (updateStmnt._1 == StandardOperator.Plus) {
//            val updatedLowerbound = create.expression(StandardOperator.Plus, e.first, create.expression(StandardOperator.Mult, rewrite(updateStmnt._2), rewrite(K)))
//            val updatedInvariant = create.expression(StandardOperator.LTE, updatedLowerbound, rewrite(e.second))
...
//        case StandardOperator.GT if e.second.equals(itervar) =>
//          cb.appendInvariant(rewrite(e))
//          lowerbounds ++= Set(create.expression(StandardOperator.Plus, e.first, create.constant(1))) // Lowerbound
//        case StandardOperator.GTE if e.second.equals(itervar) =>
//          cb.appendInvariant(rewrite(e))
//          lowerbounds ++= Set(e.first) // Lowerbound
//        case StandardOperator.LT if e.first.equals(itervar) =>
//          cb.appendInvariant(rewrite(e))
//          upperbounds ++= Set(create.expression(StandardOperator.Minus, e.second, create.constant(1))) // Upperbound
//        case StandardOperator.LTE if e.first.equals(itervar)=>
//          cb.appendInvariant(rewrite(e))
//          upperbounds ++= Set(e.second) // Upperbound
//        case StandardOperator.GT if e.first.equals(itervar) =>
//          cb.appendInvariant(rewrite(e))
//          upperbounds ++= Set(create.expression(StandardOperator.Minus, e.second, create.constant(1))) // Upperbound
//        case StandardOperator.GTE if e.first.equals(itervar) =>
//          cb.appendInvariant(rewrite(e))
//          upperbounds ++= Set(e.second) // Upperbound
