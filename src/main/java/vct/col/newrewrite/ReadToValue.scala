...
import vct.col.newrewrite.ReadToValue.WildcardError
...
object ReadToValue extends RewriterBuilder {
  ...
  case class WildcardError(node: ReadPerm[_]) extends UserError {
    ...
    override def text: String = node.o.messageInContext("You cannot have a wildcard outside of a permission statement.")
  }
