...
import org.antlr.v4.runtime.atn.{ATNConfigSet, ATNState, SingletonPredictionContext}
...
case class CollectingErrorListener(baseOrigin: Origin) extends ANTLRErrorListener with LazyLogging {
  ...
  case class FullContext(
    ...
    def origin: Origin = {
      ...
      baseOrigin.withContent(PositionRange(startLineIdx, endLineIdx, Some((startColIdx, endColIdx))))
    }
