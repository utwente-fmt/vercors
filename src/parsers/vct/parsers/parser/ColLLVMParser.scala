...
case class ColLLVMParser(
  ...
  override def parseReader[G](
    ...
    val command = Seq(
      ...
      s"--passes=function($prePStr),module(pallas-declare-variables,pallas-collect-module-spec),function(pallas-declare-function,pallas-assign-pure,llvm-declare-function-contract),module(pallas-declare-function-contract),function(pallas-transform-function-body),module(pallas-print-protobuf)",
      "--disable-output",
    )
