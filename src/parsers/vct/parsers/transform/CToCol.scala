...
case class CToCol[G](override val originProvider: OriginProvider, override val errors: Seq[(Token, Token, CancellativeFailureGrouping[G])]) extends ToCol(originProvider, errors) {
