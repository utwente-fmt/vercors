...
class JavaImportSpec extends VercorsSpec {
  ...
  vercors should verify using anyBackend example "concepts/import/src/Sqrt.java"
  vercors should verify using anyBackend example "concepts/import/src/SqrtStar.java"
}
