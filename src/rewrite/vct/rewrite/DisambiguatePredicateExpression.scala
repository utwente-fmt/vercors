...
import vct.rewrite.DisambiguatePredicateExpression.WrongFoldTarget
...
case class DisambiguatePredicateExpression[Pre <: Generation]()
  ...
  def predInv(e: Expr[Pre]): ApplyAnyPredicate[Post] =
    e match {
  ...
  def foldTarget(e: Expr[Pre]): FoldTarget[Post] =
    e match {
      case Scale(scale, e) =>
        ScaledPredicateApply(predInv(e), dispatch(scale))(e.o)
      ...
      case other => ScaledPredicateApply(predInv(other), WritePerm()(e.o))(e.o)
    }
