...
case object EncodeTryThrowSignals extends RewriterBuilder {
  ...
  case object ExcVar extends Origin {
    ...
    override def context: String =
      "[At variable generated to contain thrown exception]"
  ...
  case object CurrentlyHandling extends Origin {
    ...
    override def context: String =
      "[At variable generated to remember exception currently being handled]"
  ...
  case object ExcBeforeLoop extends Origin {
    ...
    override def context: String =
      "[At variable generated to contain exc before loop]"
