...
import vct.col.rewrite.Explode.{
  AssumeFunction,
  UnknownDeclaration,
...
case object Explode extends RewriterBuilderArg[Boolean] {
  ...
  case object ExplodeOrigin extends Origin {
    ...
    override def context: String =
      "At: [node generated to split out verification]"
    override def inlineContext: String =
      "[Node generated to split out verification]"
  ...
  case class AssumeFunction(inner: Origin) extends Origin {
    override def preferredName: String =
      "assume" + inner.preferredName.capitalize
