...
source_filename = "/home/rme/repos/vercors/examples/concepts/llvm/pallas/pallas_c_lower_bound.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%pallas.fracT = type { i64, i64, i64, i64 }

@llvm.used = appending global [11 x ptr] [ptr @PALLAS_SPEC_0, ptr @PALLAS_SPEC_1, ptr @PALLAS_SPEC_2, ptr @PALLAS_SPEC_3, ptr @PALLAS_SPEC_4, ptr @PALLAS_SPEC_5, ptr @PALLAS_SPEC_6, ptr @PALLAS_SPEC_10, ptr @PALLAS_SPEC_7, ptr @PALLAS_SPEC_8, ptr @PALLAS_SPEC_9], section "llvm.metadata"
@.str = private unnamed_addr constant [2 x i8] c"i\00", align 1, !dbg !0

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @foo(ptr noundef %0, i32 noundef %1) #0 !dbg !21 !pallas.fcontract !28 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @PALLAS_SPEC_10(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 !dbg !160 !pallas.exprWrapper !88 {
  ...
  %5 = call i32 @pallas.boundVar.0(ptr @.str), !dbg !166
  %6 = icmp sle i32 0, %5, !dbg !167
  %7 = call i32 @pallas.boundVar.0(ptr @.str), !dbg !168
  %8 = icmp slt i32 %7, %2, !dbg !169
  %9 = call i1 @pallas.scAnd(i1 %6, i1 %8), !dbg !170
  %10 = call i32 @pallas.boundVar.0(ptr @.str), !dbg !171
  %11 = sext i32 %10 to i64, !dbg !172
  %12 = getelementptr inbounds i32, ptr %0, i64 %11, !dbg !172
  %13 = load i32, ptr %12, align 4, !dbg !172
  %14 = icmp sge i32 %13, %3, !dbg !173
  %15 = call i1 @pallas.forall(i1 %9, i1 %14), !dbg !174
  ret i1 %15, !dbg !162
}

; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @PALLAS_SPEC_7(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 !dbg !175 !pallas.exprWrapper !88 {
  ...
  call void @llvm.dbg.value(metadata i32 %2, metadata !179, metadata !DIExpression()), !dbg !177
  call void @llvm.dbg.value(metadata i32 %3, metadata !180, metadata !DIExpression()), !dbg !177
  %5 = icmp sle i32 1, %2, !dbg !181
  %6 = icmp sle i32 %2, %1, !dbg !182
  %7 = call i1 @pallas.scAnd(i1 %5, i1 %6), !dbg !183
  ret i1 %7, !dbg !177
}

; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @PALLAS_SPEC_8(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 !dbg !184 !pallas.exprWrapper !88 {
  ...
  call void @llvm.dbg.value(metadata i32 %2, metadata !188, metadata !DIExpression()), !dbg !186
  call void @llvm.dbg.value(metadata i32 %3, metadata !189, metadata !DIExpression()), !dbg !186
  %5 = call i64 @pallas.ptrLength(ptr noundef %0), !dbg !190
  %6 = sext i32 %1 to i64, !dbg !191
  %7 = icmp eq i64 %5, %6, !dbg !192
  ret i1 %7, !dbg !186
}

; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @PALLAS_SPEC_9(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 !dbg !193 !pallas.exprWrapper !88 {
  %5 = alloca %pallas.fracT, align 8
  call void @llvm.dbg.value(metadata ptr %0, metadata !194, metadata !DIExpression()), !dbg !195
  call void @llvm.dbg.value(metadata i32 %1, metadata !196, metadata !DIExpression()), !dbg !195
  call void @llvm.dbg.value(metadata i32 %2, metadata !197, metadata !DIExpression()), !dbg !195
  call void @llvm.dbg.value(metadata i32 %3, metadata !198, metadata !DIExpression()), !dbg !195
  %6 = call i32 @pallas.boundVar.0(ptr @.str), !dbg !199
  %7 = icmp sle i32 0, %6, !dbg !200
  %8 = call i32 @pallas.boundVar.0(ptr @.str), !dbg !201
  %9 = icmp slt i32 %8, %1, !dbg !202
  %10 = call i1 @pallas.scAnd(i1 %7, i1 %9), !dbg !203
  %11 = call i32 @pallas.boundVar.0(ptr @.str), !dbg !204
  %12 = sext i32 %11 to i64, !dbg !205
  %13 = getelementptr inbounds i32, ptr %0, i64 %12, !dbg !205
  call void @pallas.fracOf(ptr sret(%pallas.fracT) %5, i32 noundef 1, i32 noundef 2), !dbg !206
  %14 = call i1 @pallas.perm(ptr noundef %13, ptr noundef byval(%pallas.fracT) %5), !dbg !207
  %15 = call i1 @pallas.forallSep(i1 %10, i1 %14), !dbg !208
  ret i1 %15, !dbg !195
}
...
declare !pallas.specLib !210 i1 @pallas.forall(i1, i1)

declare !pallas.specLib !211 i64 @pallas.ptrLength(ptr noundef)

declare !pallas.specLib !212 i1 @pallas.forallSep(i1, i1)
...
!2 = !DIFile(filename: "tmp/source_wrappers.c", directory: ".", checksumkind: CSK_MD5, checksum: "79704ad090609ded13985716f266f8d4")
...
!8 = !DIFile(filename: "/home/rme/repos/vercors/examples/concepts/llvm/pallas/pallas_c_lower_bound.c", directory: ".", checksumkind: CSK_MD5, checksum: "efcb7277c13ae93349fe27ab9ec2fd39")
...
!21 = distinct !DISubprogram(name: "foo", scope: !22, file: !22, line: 19, type: !23, scopeLine: 19, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!22 = !DIFile(filename: "/home/rme/repos/vercors/examples/concepts/llvm/pallas/pallas_c_lower_bound.c", directory: "", checksumkind: CSK_MD5, checksum: "efcb7277c13ae93349fe27ab9ec2fd39")
...
!29 = !{!"pallas.srcLoc", i64 8, i64 1, i64 18, i64 1, !22}
!30 = !{!"pallas.requires", !31, ptr @PALLAS_SPEC_0, !32, !33}
!31 = !{!"pallas.srcLoc", i64 9, i64 1, i64 9, i64 30, !22}
!32 = !DILocalVariable(name: "arr", arg: 1, scope: !21, file: !22, line: 19, type: !26)
!33 = !DILocalVariable(name: "n", arg: 2, scope: !21, file: !22, line: 19, type: !25)
!34 = !{!"pallas.requires", !35, ptr @PALLAS_SPEC_1, !32, !33}
!35 = !{!"pallas.srcLoc", i64 10, i64 1, i64 10, i64 31, !22}
!36 = !{!"pallas.requires", !37, ptr @PALLAS_SPEC_2, !32, !33}
!37 = !{!"pallas.srcLoc", i64 11, i64 1, i64 12, i64 87, !22}
!38 = !{!"pallas.ensures", !39, ptr @PALLAS_SPEC_3, !32, !33}
!39 = !{!"pallas.srcLoc", i64 13, i64 1, i64 13, i64 30, !22}
!40 = !{!"pallas.ensures", !41, ptr @PALLAS_SPEC_4, !32, !33}
!41 = !{!"pallas.srcLoc", i64 14, i64 1, i64 15, i64 86, !22}
!42 = !{!"pallas.ensures", !43, ptr @PALLAS_SPEC_5, !32, !33}
!43 = !{!"pallas.srcLoc", i64 16, i64 1, i64 17, i64 78, !22}
!44 = !DILocation(line: 19, column: 14, scope: !21)
!45 = !DILocation(line: 19, column: 23, scope: !21)
!46 = !DILocalVariable(name: "idx", scope: !21, file: !22, line: 20, type: !25)
!47 = !DILocation(line: 20, column: 9, scope: !21)
!48 = !DILocalVariable(name: "min", scope: !21, file: !22, line: 21, type: !25)
...
!56 = distinct !DILexicalBlock(scope: !57, file: !22, line: 33, column: 13)
!57 = distinct !DILexicalBlock(scope: !21, file: !22, line: 32, column: 21)
...
!71 = !{!"pallas.srcLoc", i64 23, i64 5, i64 31, i64 5, !22}
!72 = !{!73, ptr @PALLAS_SPEC_6, !32, !33, !46, !48}
!73 = !{!"pallas.srcLoc", i64 24, i64 5, i64 24, i64 31, !22}
!74 = !{!75, ptr @PALLAS_SPEC_7, !32, !33, !46, !48}
!75 = !{!"pallas.srcLoc", i64 25, i64 5, i64 25, i64 44, !22}
!76 = !{!77, ptr @PALLAS_SPEC_8, !32, !33, !46, !48}
!77 = !{!"pallas.srcLoc", i64 26, i64 5, i64 26, i64 41, !22}
!78 = !{!79, ptr @PALLAS_SPEC_9, !32, !33, !46, !48}
!79 = !{!"pallas.srcLoc", i64 27, i64 5, i64 28, i64 97, !22}
!80 = !{!81, ptr @PALLAS_SPEC_10, !32, !33, !46, !48}
!81 = !{!"pallas.srcLoc", i64 29, i64 5, i64 30, i64 82, !22}
!82 = !DILocation(line: 38, column: 12, scope: !21)
!83 = !DILocation(line: 38, column: 5, scope: !21)
!84 = distinct !DISubprogram(name: "PALLAS_SPEC_0", scope: !22, file: !22, line: 9, type: !85, scopeLine: 9, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!85 = !DISubroutineType(types: !86)
!86 = !{!87, !26, !25}
!87 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!88 = !{!""}
!89 = !DILocalVariable(name: "arr", arg: 1, scope: !84, file: !22, line: 9, type: !26)
!90 = !DILocation(line: 0, scope: !84)
!91 = !DILocalVariable(name: "n", arg: 2, scope: !84, file: !22, line: 9, type: !25)
!92 = !DILocation(line: 9, column: 14, scope: !84)
!93 = !DILocation(line: 9, column: 22, scope: !84)
!94 = !DILocation(line: 9, column: 27, scope: !84)
!95 = distinct !DISubprogram(name: "PALLAS_SPEC_1", scope: !22, file: !22, line: 10, type: !85, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!96 = !DILocalVariable(name: "arr", arg: 1, scope: !95, file: !22, line: 10, type: !26)
!97 = !DILocation(line: 0, scope: !95)
!98 = !DILocalVariable(name: "n", arg: 2, scope: !95, file: !22, line: 10, type: !25)
...
!102 = distinct !DISubprogram(name: "PALLAS_SPEC_2", scope: !22, file: !22, line: 11, type: !85, scopeLine: 11, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!103 = !DILocalVariable(name: "arr", arg: 1, scope: !102, file: !22, line: 11, type: !26)
!104 = !DILocation(line: 0, scope: !102)
!105 = !DILocalVariable(name: "n", arg: 2, scope: !102, file: !22, line: 11, type: !25)
...
!116 = distinct !DISubprogram(name: "PALLAS_SPEC_3", scope: !22, file: !22, line: 13, type: !85, scopeLine: 13, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!117 = !DILocalVariable(name: "arr", arg: 1, scope: !116, file: !22, line: 13, type: !26)
!118 = !DILocation(line: 0, scope: !116)
!119 = !DILocalVariable(name: "n", arg: 2, scope: !116, file: !22, line: 13, type: !25)
...
!123 = distinct !DISubprogram(name: "PALLAS_SPEC_4", scope: !22, file: !22, line: 14, type: !85, scopeLine: 14, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!124 = !DILocalVariable(name: "arr", arg: 1, scope: !123, file: !22, line: 14, type: !26)
!125 = !DILocation(line: 0, scope: !123)
!126 = !DILocalVariable(name: "n", arg: 2, scope: !123, file: !22, line: 14, type: !25)
...
!137 = distinct !DISubprogram(name: "PALLAS_SPEC_5", scope: !22, file: !22, line: 16, type: !85, scopeLine: 16, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!138 = !DILocalVariable(name: "arr", arg: 1, scope: !137, file: !22, line: 16, type: !26)
!139 = !DILocation(line: 0, scope: !137)
!140 = !DILocalVariable(name: "n", arg: 2, scope: !137, file: !22, line: 16, type: !25)
...
!151 = distinct !DISubprogram(name: "PALLAS_SPEC_6", scope: !22, file: !22, line: 24, type: !152, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!152 = !DISubroutineType(types: !153)
!153 = !{!87, !26, !25, !25, !25}
!154 = !DILocalVariable(name: "arr", arg: 1, scope: !151, file: !22, line: 24, type: !26)
!155 = !DILocation(line: 0, scope: !151)
!156 = !DILocalVariable(name: "n", arg: 2, scope: !151, file: !22, line: 24, type: !25)
!157 = !DILocalVariable(name: "idx", arg: 3, scope: !151, file: !22, line: 24, type: !25)
!158 = !DILocalVariable(name: "min", arg: 4, scope: !151, file: !22, line: 24, type: !25)
!159 = !DILocation(line: 24, column: 24, scope: !151)
!160 = distinct !DISubprogram(name: "PALLAS_SPEC_10", scope: !22, file: !22, line: 29, type: !152, scopeLine: 29, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!161 = !DILocalVariable(name: "arr", arg: 1, scope: !160, file: !22, line: 29, type: !26)
!162 = !DILocation(line: 0, scope: !160)
!163 = !DILocalVariable(name: "n", arg: 2, scope: !160, file: !22, line: 29, type: !25)
!164 = !DILocalVariable(name: "idx", arg: 3, scope: !160, file: !22, line: 29, type: !25)
!165 = !DILocalVariable(name: "min", arg: 4, scope: !160, file: !22, line: 29, type: !25)
!166 = !DILocation(line: 29, column: 38, scope: !160)
!167 = !DILocation(line: 29, column: 35, scope: !160)
!168 = !DILocation(line: 30, column: 38, scope: !160)
!169 = !DILocation(line: 30, column: 50, scope: !160)
!170 = !DILocation(line: 29, column: 28, scope: !160)
!171 = !DILocation(line: 30, column: 62, scope: !160)
!172 = !DILocation(line: 30, column: 58, scope: !160)
!173 = !DILocation(line: 30, column: 75, scope: !160)
!174 = !DILocation(line: 29, column: 20, scope: !160)
!175 = distinct !DISubprogram(name: "PALLAS_SPEC_7", scope: !22, file: !22, line: 25, type: !152, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!176 = !DILocalVariable(name: "arr", arg: 1, scope: !175, file: !22, line: 25, type: !26)
!177 = !DILocation(line: 0, scope: !175)
!178 = !DILocalVariable(name: "n", arg: 2, scope: !175, file: !22, line: 25, type: !25)
!179 = !DILocalVariable(name: "idx", arg: 3, scope: !175, file: !22, line: 25, type: !25)
!180 = !DILocalVariable(name: "min", arg: 4, scope: !175, file: !22, line: 25, type: !25)
!181 = !DILocation(line: 25, column: 27, scope: !175)
!182 = !DILocation(line: 25, column: 39, scope: !175)
!183 = !DILocation(line: 25, column: 20, scope: !175)
!184 = distinct !DISubprogram(name: "PALLAS_SPEC_8", scope: !22, file: !22, line: 26, type: !152, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!185 = !DILocalVariable(name: "arr", arg: 1, scope: !184, file: !22, line: 26, type: !26)
!186 = !DILocation(line: 0, scope: !184)
!187 = !DILocalVariable(name: "n", arg: 2, scope: !184, file: !22, line: 26, type: !25)
!188 = !DILocalVariable(name: "idx", arg: 3, scope: !184, file: !22, line: 26, type: !25)
!189 = !DILocalVariable(name: "min", arg: 4, scope: !184, file: !22, line: 26, type: !25)
!190 = !DILocation(line: 26, column: 20, scope: !184)
!191 = !DILocation(line: 26, column: 40, scope: !184)
!192 = !DILocation(line: 26, column: 37, scope: !184)
!193 = distinct !DISubprogram(name: "PALLAS_SPEC_9", scope: !22, file: !22, line: 27, type: !152, scopeLine: 27, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !27)
!194 = !DILocalVariable(name: "arr", arg: 1, scope: !193, file: !22, line: 27, type: !26)
!195 = !DILocation(line: 0, scope: !193)
!196 = !DILocalVariable(name: "n", arg: 2, scope: !193, file: !22, line: 27, type: !25)
!197 = !DILocalVariable(name: "idx", arg: 3, scope: !193, file: !22, line: 27, type: !25)
!198 = !DILocalVariable(name: "min", arg: 4, scope: !193, file: !22, line: 27, type: !25)
!199 = !DILocation(line: 27, column: 39, scope: !193)
!200 = !DILocation(line: 27, column: 36, scope: !193)
!201 = !DILocation(line: 28, column: 39, scope: !193)
!202 = !DILocation(line: 28, column: 51, scope: !193)
!203 = !DILocation(line: 27, column: 29, scope: !193)
!204 = !DILocation(line: 28, column: 68, scope: !193)
!205 = !DILocation(line: 28, column: 64, scope: !193)
!206 = !DILocation(line: 28, column: 82, scope: !193)
!207 = !DILocation(line: 28, column: 57, scope: !193)
!208 = !DILocation(line: 27, column: 20, scope: !193)
!209 = !{!"pallas.result"}
!210 = !{!"pallas.forall"}
!211 = !{!"pallas.ptrLength"}
!212 = !{!"pallas.forallSep"}
!213 = !{!"pallas.perm"}
!214 = !{!"pallas.fracOf"}
!215 = !{!"pallas.scAnd"}
!216 = !{!"pallas.boundVar"}
