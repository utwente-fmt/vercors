...
define dso_local zeroext i1 @PALLAS_SPEC_8(ptr noundef %0, i32 noundef %1) #0 !dbg !149 !pallas.exprWrapper !77 {
  ...
  %4 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !153
  %5 = icmp sle i32 0, %4, !dbg !154
  %6 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !155
  %7 = icmp slt i32 %6, %1, !dbg !156
  %8 = call i1 @pallas.scAnd(i1 %5, i1 %7), !dbg !157
  %9 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !158
...
define dso_local zeroext i1 @PALLAS_SPEC_10(ptr noundef %0, i32 noundef %1) #0 !dbg !170 !pallas.exprWrapper !77 {
  ...
  %4 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !174
  %5 = icmp sle i32 0, %4, !dbg !175
  %6 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !176
  %7 = icmp slt i32 %6, %1, !dbg !177
  %8 = call i1 @pallas.scAnd(i1 %5, i1 %7), !dbg !178
  %9 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !179
...
define dso_local zeroext i1 @PALLAS_SPEC_11(ptr noundef %0, i32 noundef %1) #0 !dbg !184 !pallas.exprWrapper !77 {
  ...
  %3 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !188
  %4 = icmp sle i32 0, %3, !dbg !189
  %5 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !190
  %6 = icmp slt i32 %5, %1, !dbg !191
  %7 = call i1 @pallas.scAnd(i1 %4, i1 %6), !dbg !192
  %8 = call i32 @"pallas.boundVar i32"(ptr @.str), !dbg !193
...
declare !pallas.specLib !206 i32 @"pallas.boundVar i32"(ptr)
...
!32 = !DILocalVariable(name: "arr", arg: 1, scope: !21, file: !8, line: 17, type: !24)
!33 = !DILocalVariable(name: "n", arg: 2, scope: !21, file: !8, line: 17, type: !25)
!34 = !{!"pallas.requires", !35, ptr @PALLAS_SPEC_1, !32, !33}
!35 = !{!"pallas.srcLoc", i64 9, i64 1, i64 9, i64 68, !29}
!36 = !{!"pallas.requires", !37, ptr @PALLAS_SPEC_2, !32, !33}
!37 = !{!"pallas.srcLoc", i64 10, i64 1, i64 11, i64 36, !29}
!38 = !{!"pallas.ensures", !39, ptr @PALLAS_SPEC_3, !32, !33}
!39 = !{!"pallas.srcLoc", i64 12, i64 1, i64 12, i64 67, !29}
!40 = !{!"pallas.ensures", !41, ptr @PALLAS_SPEC_4, !32, !33}
!41 = !{!"pallas.srcLoc", i64 13, i64 1, i64 14, i64 35, !29}
!42 = !{!"pallas.ensures", !43, ptr @PALLAS_SPEC_5, !32, !33}
!43 = !{!"pallas.srcLoc", i64 15, i64 1, i64 15, i64 35, !29}
...
!51 = distinct !DISubprogram(name: "foo", scope: !8, file: !8, line: 34, type: !22, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!52 = !{!53, i1 false, i1 false, !54, !58, !60, !62, !64, !66}
!53 = !{!"pallas.srcLoc", i64 23, i64 1, i64 33, i64 1, !29}
!54 = !{!"pallas.requires", !55, ptr @PALLAS_SPEC_6, !56, !57}
!55 = !{!"pallas.srcLoc", i64 24, i64 1, i64 24, i64 30, !29}
!56 = !DILocalVariable(name: "arr", arg: 1, scope: !51, file: !8, line: 34, type: !24)
!57 = !DILocalVariable(name: "n", arg: 2, scope: !51, file: !8, line: 34, type: !25)
!58 = !{!"pallas.requires", !59, ptr @PALLAS_SPEC_7, !56, !57}
!59 = !{!"pallas.srcLoc", i64 25, i64 1, i64 25, i64 31, !29}
!60 = !{!"pallas.requires", !61, ptr @PALLAS_SPEC_8, !56, !57}
!61 = !{!"pallas.srcLoc", i64 26, i64 1, i64 27, i64 80, !29}
!62 = !{!"pallas.ensures", !63, ptr @PALLAS_SPEC_9, !56, !57}
!63 = !{!"pallas.srcLoc", i64 28, i64 1, i64 28, i64 30, !29}
!64 = !{!"pallas.ensures", !65, ptr @PALLAS_SPEC_10, !56, !57}
!65 = !{!"pallas.srcLoc", i64 29, i64 1, i64 30, i64 79, !29}
!66 = !{!"pallas.ensures", !67, ptr @PALLAS_SPEC_11, !56, !57}
!67 = !{!"pallas.srcLoc", i64 31, i64 1, i64 32, i64 67, !29}
...
!73 = distinct !DISubprogram(name: "PALLAS_SPEC_0", scope: !8, file: !8, line: 8, type: !74, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!74 = !DISubroutineType(types: !75)
!75 = !{!76, !24, !25}
!76 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!77 = !{!""}
!78 = !DILocalVariable(name: "arr", arg: 1, scope: !73, file: !8, line: 8, type: !24)
!79 = !DILocation(line: 0, scope: !73)
!80 = !DILocalVariable(name: "n", arg: 2, scope: !73, file: !8, line: 8, type: !25)
!81 = !DILocation(line: 8, column: 14, scope: !73)
!82 = !DILocation(line: 8, column: 22, scope: !73)
!83 = !DILocation(line: 8, column: 27, scope: !73)
!84 = distinct !DISubprogram(name: "PALLAS_SPEC_1", scope: !8, file: !8, line: 9, type: !74, scopeLine: 9, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!85 = !DILocalVariable(name: "arr", arg: 1, scope: !84, file: !8, line: 9, type: !24)
!86 = !DILocation(line: 0, scope: !84)
!87 = !DILocalVariable(name: "n", arg: 2, scope: !84, file: !8, line: 9, type: !25)
...
!94 = distinct !DISubprogram(name: "PALLAS_SPEC_2", scope: !8, file: !8, line: 10, type: !74, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!95 = !DILocalVariable(name: "arr", arg: 1, scope: !94, file: !8, line: 10, type: !24)
!96 = !DILocation(line: 0, scope: !94)
!97 = !DILocalVariable(name: "n", arg: 2, scope: !94, file: !8, line: 10, type: !25)
...
!105 = distinct !DISubprogram(name: "PALLAS_SPEC_3", scope: !8, file: !8, line: 12, type: !74, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!106 = !DILocalVariable(name: "arr", arg: 1, scope: !105, file: !8, line: 12, type: !24)
!107 = !DILocation(line: 0, scope: !105)
!108 = !DILocalVariable(name: "n", arg: 2, scope: !105, file: !8, line: 12, type: !25)
...
!115 = distinct !DISubprogram(name: "PALLAS_SPEC_4", scope: !8, file: !8, line: 13, type: !74, scopeLine: 13, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!116 = !DILocalVariable(name: "arr", arg: 1, scope: !115, file: !8, line: 13, type: !24)
!117 = !DILocation(line: 0, scope: !115)
!118 = !DILocalVariable(name: "n", arg: 2, scope: !115, file: !8, line: 13, type: !25)
...
!126 = distinct !DISubprogram(name: "PALLAS_SPEC_5", scope: !8, file: !8, line: 15, type: !74, scopeLine: 15, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!127 = !DILocalVariable(name: "arr", arg: 1, scope: !126, file: !8, line: 15, type: !24)
!128 = !DILocation(line: 0, scope: !126)
!129 = !DILocalVariable(name: "n", arg: 2, scope: !126, file: !8, line: 15, type: !25)
...
!135 = distinct !DISubprogram(name: "PALLAS_SPEC_6", scope: !8, file: !8, line: 24, type: !74, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!136 = !DILocalVariable(name: "arr", arg: 1, scope: !135, file: !8, line: 24, type: !24)
!137 = !DILocation(line: 0, scope: !135)
!138 = !DILocalVariable(name: "n", arg: 2, scope: !135, file: !8, line: 24, type: !25)
...
!142 = distinct !DISubprogram(name: "PALLAS_SPEC_7", scope: !8, file: !8, line: 25, type: !74, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!143 = !DILocalVariable(name: "arr", arg: 1, scope: !142, file: !8, line: 25, type: !24)
!144 = !DILocation(line: 0, scope: !142)
!145 = !DILocalVariable(name: "n", arg: 2, scope: !142, file: !8, line: 25, type: !25)
...
!149 = distinct !DISubprogram(name: "PALLAS_SPEC_8", scope: !8, file: !8, line: 26, type: !74, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!150 = !DILocalVariable(name: "arr", arg: 1, scope: !149, file: !8, line: 26, type: !24)
!151 = !DILocation(line: 0, scope: !149)
!152 = !DILocalVariable(name: "n", arg: 2, scope: !149, file: !8, line: 26, type: !25)
...
!163 = distinct !DISubprogram(name: "PALLAS_SPEC_9", scope: !8, file: !8, line: 28, type: !74, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!164 = !DILocalVariable(name: "arr", arg: 1, scope: !163, file: !8, line: 28, type: !24)
!165 = !DILocation(line: 0, scope: !163)
!166 = !DILocalVariable(name: "n", arg: 2, scope: !163, file: !8, line: 28, type: !25)
...
!170 = distinct !DISubprogram(name: "PALLAS_SPEC_10", scope: !8, file: !8, line: 29, type: !74, scopeLine: 29, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!171 = !DILocalVariable(name: "arr", arg: 1, scope: !170, file: !8, line: 29, type: !24)
!172 = !DILocation(line: 0, scope: !170)
!173 = !DILocalVariable(name: "n", arg: 2, scope: !170, file: !8, line: 29, type: !25)
...
!184 = distinct !DISubprogram(name: "PALLAS_SPEC_11", scope: !8, file: !8, line: 31, type: !74, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !26)
!185 = !DILocalVariable(name: "arr", arg: 1, scope: !184, file: !8, line: 31, type: !24)
!186 = !DILocation(line: 0, scope: !184)
!187 = !DILocalVariable(name: "n", arg: 2, scope: !184, file: !8, line: 31, type: !25)
