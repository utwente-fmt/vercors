...
define dso_local zeroext i1 @PALLAS_SPEC_2(i32 noundef %0, i32 noundef %1) #0 !dbg !72 !pallas.exprWrapper !62 {
  ...
  %3 = call i32 @"pallas.result i32"(), !dbg !76
...
; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @PALLAS_SPEC_4(i32 noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 !dbg !79 !pallas.exprWrapper !62 {
  ...
  %5 = mul nsw i32 %3, %0, !dbg !87
  %6 = icmp eq i32 %2, %5, !dbg !88
  ret i1 %6, !dbg !83
}

; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @PALLAS_SPEC_3(i32 noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 !dbg !89 !pallas.exprWrapper !62 {
  ...
  call void @llvm.dbg.value(metadata i32 %3, metadata !94, metadata !DIExpression()), !dbg !91
  %5 = icmp sle i32 0, %3, !dbg !95
  %6 = icmp sle i32 %3, %1, !dbg !96
  %7 = call i1 @pallas.scAnd(i1 %5, i1 %6), !dbg !97
  ret i1 %7, !dbg !91
}
...
declare !pallas.specLib !98 i32 @"pallas.result i32"()
...
!79 = distinct !DISubprogram(name: "PALLAS_SPEC_4", scope: !1, file: !1, line: 18, type: !80, scopeLine: 18, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !16)
!80 = !DISubroutineType(types: !81)
!81 = !{!61, !15, !15, !15, !15}
!82 = !DILocalVariable(name: "n", arg: 1, scope: !79, file: !1, line: 18, type: !15)
!83 = !DILocation(line: 0, scope: !79)
!84 = !DILocalVariable(name: "k", arg: 2, scope: !79, file: !1, line: 18, type: !15)
!85 = !DILocalVariable(name: "res", arg: 3, scope: !79, file: !1, line: 18, type: !15)
!86 = !DILocalVariable(name: "i", arg: 4, scope: !79, file: !1, line: 18, type: !15)
!87 = !DILocation(line: 18, column: 29, scope: !79)
!88 = !DILocation(line: 18, column: 24, scope: !79)
!89 = distinct !DISubprogram(name: "PALLAS_SPEC_3", scope: !1, file: !1, line: 17, type: !80, scopeLine: 17, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !16)
!90 = !DILocalVariable(name: "n", arg: 1, scope: !89, file: !1, line: 17, type: !15)
!91 = !DILocation(line: 0, scope: !89)
!92 = !DILocalVariable(name: "k", arg: 2, scope: !89, file: !1, line: 17, type: !15)
!93 = !DILocalVariable(name: "res", arg: 3, scope: !89, file: !1, line: 17, type: !15)
!94 = !DILocalVariable(name: "i", arg: 4, scope: !89, file: !1, line: 17, type: !15)
!95 = !DILocation(line: 17, column: 27, scope: !89)
!96 = !DILocation(line: 17, column: 35, scope: !89)
!97 = !DILocation(line: 17, column: 20, scope: !89)
!98 = !{!"pallas.result"}
!99 = !{!"pallas.scAnd"}
