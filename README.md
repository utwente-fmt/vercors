...
- Optionally `cmake`, `make` and `libllvm17-dev` if you would like to build Pallas (this is currently restricted to Linux)
...
4. (optional) Enable building VCLLVM with `touch .include-pallas`
