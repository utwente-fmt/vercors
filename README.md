...
1. Clone this Git branch using `https://github.com/utwente-fmt/vercors.git` and move into the cloned directory, `cd vercors`.
...
The VeyMont tool can be used by running:
 ...
 `--veymont <filepath-to-file-for-local-programs> <filepath-to-global-program>`
