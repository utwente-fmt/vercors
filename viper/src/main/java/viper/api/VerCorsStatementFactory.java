...
public class VerCorsStatementFactory implements
  ...
  public ASTNode method_call(Origin o, String name,
      ...
      java.util.List<Triple<Origin,String,Type>> pars,
      java.util.List<Triple<Origin,String,Type>> rets) {
    enter(o);
  ...
  public ASTNode while_loop(Origin o, ASTNode cond,
                            ...
                            java.util.List<Triple<Origin,String,Type>> locals, ASTNode body) {
    enter(o);
    BlockStatement block=create.block();
    for(Triple<Origin,String,Type> e:locals){
