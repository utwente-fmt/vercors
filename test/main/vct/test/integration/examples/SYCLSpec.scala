...
class SYCLSpec extends VercorsSpec {
  ...
  vercors should failVerification withCode "ptrPerm" using silicon example "concepts/sycl/buffers/ReadDataInBufferScope.cpp"
  ...
  vercors should failVerification withCode "assignFieldFailed" using silicon example "concepts/sycl/buffers/WriteDataInBufferScope.cpp"
  ...
  vercors should failVerification withCode "arrayBounds" using silicon example "concepts/sycl/localAccessors/SubscriptOutOfBounds1.cpp"
  vercors should failVerification withCode "arrayBounds" using silicon example "concepts/sycl/localAccessors/SubscriptOutOfBounds2.cpp"
