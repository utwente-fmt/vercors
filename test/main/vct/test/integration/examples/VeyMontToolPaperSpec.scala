...
class VeyMontToolPaperSpec extends VercorsSpec {
  ...
  vercors should verify using silicon example s"$applicability/2pc-3.pvl"
  vercors should verify using silicon example s"$applicability/2pc-5.pvl"
  vercors should verify using silicon example s"$applicability/2pc-8.pvl"
  vercors should verify using silicon example s"$applicability/2pc-12.pvl"
  vercors should verify using silicon example s"$applicability/2pc-17.pvl"
  vercors should verify using silicon example s"$applicability/consensus-3.pvl"
  vercors should verify using silicon example s"$applicability/consensus-5.pvl"
  vercors should verify using silicon example s"$applicability/election-3.pvl"
  vercors should verify using silicon example s"$applicability/election-5.pvl"
  vercors should verify using silicon example s"$applicability/election-8.pvl"
