...
class SYCLFullProgramsSpec extends VercorsSpec {
  ...
  vercors should verify using silicon flags("--no-infer-heap-context-into-frame", "--backend-option", "--proverEnableResourceBounds") example "concepts/sycl/fullExamples/MatrixTransposeWithF.cpp"
}
