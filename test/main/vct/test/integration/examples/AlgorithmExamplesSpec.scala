...
class AlgorithmExamplesSpec extends VercorsSpec {
  ...
  vercors should verify using silicon example "concepts/algo/reachability.pvl"
  vercors should verify using silicon example "concepts/algo/reachability_par.pvl"
