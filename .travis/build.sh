...
./.travis/travis_fold.sh test "Executing tests" "./bin/vct --progress --test=$TRAVIS_BUILD_DIR/examples --test-workers=2 --tool=silicon --exclude-suite=slow,medium,problem-fail,skip-travis"
