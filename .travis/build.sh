...
./.travis/travis_fold.sh test "Executing tests" "./bin/vct --progress --test=$TRAVIS_BUILD_DIR/examples/travis-fail.pvl --travis-test-output --test-workers=1 --tool=silicon --exclude-suite=slow,medium,problem-fail,skip-travis"
