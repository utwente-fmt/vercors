...
final case class Chunk[G](bindings: Seq[Variable[G]], condition: Expr[G], amount: Expr[G], location: Location[G])(implicit val o: Origin) extends Expr[G] with ChunkImpl[G]
