...
public final class PrimitiveType extends Type {
                ...
                case Pointer:
                    if (t.isPrimitive(PrimitiveSort.String)) {
                        ...
                        if (tt instanceof TypeExpression) {
                            ...
                            if (te.operator() == TypeOperator.Const && te.firstType().isPrimitive(PrimitiveSort.Char))
                                return true;
                        }
    ...
    public boolean isPrimitive(PrimitiveSort sort) {
        if (sort == PrimitiveSort.String && this.sort == PrimitiveSort.Pointer && ((Type) firstarg()).isPrimitive(PrimitiveSort.Char))
            return true;
