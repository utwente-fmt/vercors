...
sealed trait Referrable[G] {
  def name: String = this match {
    ...
    case RefEnumConstant(decl) => Referrable.originName(decl)
...
case object Referrable {
  def from[G](decl: Declaration[G]): Seq[Referrable[G]] = Seq[Referrable[G]](decl match {
    ...
    case decl: JavaEnum[G] => RefJavaClass(decl)
    ...
    case decl: EnumConstant[G] => RefEnumConstant(decl)
    ...
    case decl: JavaEnumConstant[G] => RefJavaEnumConstant(decl)
...
case class RefEnum[G](decl: Enum[G]) extends Referrable[G] with PVLTypeNameTarget[G] with PVLNameTarget[G]
case class RefEnumConstant[G](decl: EnumConstant[G]) extends Referrable[G] with PVLDerefTarget[G]
...
case class RefJavaEnumConstant[G](decl: JavaEnumConstant[G]) extends Referrable[G] with JavaDerefTarget[G]
