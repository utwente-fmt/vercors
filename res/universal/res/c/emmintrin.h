...
// emmintrin.h normally contains other definitions of __m128i. It is used as a
// type for integers vectors for any size of the individual integers. And the
// specific functions used, tell us how to interpret the vector. For example,
// _mm_add_epi32 tells us that the vector is composed of 32-bit integers. In
// VerCors this is not useful, we want to know the size of the vector from the
// type, and not switch between vector interpretations. So we defined __m128i to
// be a vector of 2 integers in VerCors. Also see reference guide:
...
typedef long long __m256i
    __attribute__((__vector_size__(sizeof(long long) * 4)));
...
/*@
  requires __P != NULL ** \pointer_length(__P) >= 4 ** (\forall* int i; 0<=i &&
i<4; Perm(__P[i], read)); ensures __P[0] == \result[0] && __P[1] == \result[1]
&& __P[2] == \result[2] && __P[3] == \result[3];
@*/
...
/*@
  requires __P != NULL ** \pointer_length(__P) >= 2 ** (\forall* int i; 0<=i &&
i<2; Perm(__P[i], read)); ensures __P[0] == \result[0] && __P[1] == \result[1];
@*/
...
/*@
  requires __P != NULL ** \pointer_length((long long *)__P) >= 2 ** (\forall*
int i; 0<=i && i<2; Perm(((long long *)__P)[i], read)); ensures ((long
long*)__P)[0] == \result[0] && ((long long*)__P)[1] == \result[1];
@*/
...
/** AVX256 **/
/*@
  requires __P != NULL ** \pointer_length(__P) >= 8 ** (\forall* int i; 0<=i &&
i<8; Perm(__P[i], read)); ensures __P[0] == \result[0] && __P[1] == \result[1]
&& __P[2] == \result[2] && __P[3] == \result[3] &&
      __P[4] == \result[4] && __P[5] == \result[5] && __P[6] == \result[6] &&
__P[7] == \result[7];
@*/
...
/*@
  requires __P != NULL ** \pointer_length((long long *)__P) >= 4 ** (\forall*
int i; 0<=i && i<4; Perm(((long long *)__P)[i], read)); ensures ((long
long*)__P)[0] == \result[0] && ((long long*)__P)[1] == \result[1] && ((long
long*)__P)[2] == \result[2] && ((long long*)__P)[3] == \result[3];
@*/
...
// SSE2
/*@
  context __P != NULL ** \pointer_length(__P) >= 4 ** (\forall* int i; 0<=i &&
i<4; Perm(__P[i], write)); ensures __P[0] == __A[0] && __P[1] == __A[1] &&
__P[2] == __A[2] && __P[3] == __A[3];
@*/
...
/*@
  context __P != NULL ** \pointer_length(__P) >= 2 ** (\forall* int i; 0<=i &&
i<2; Perm(__P[i], write)); ensures __P[0] == __A[0] && __P[1] == __A[1];
@*/
...
/*@
  context __P != NULL ** \pointer_length((long long *)__P) >= 2 ** (\forall* int
i; 0<=i && i<2; Perm(((long long *)__P)[i], write)); ensures ((long long *)
__P)[0] == __A[0] && ((long long *) __P)[1] == __A[1];
@*/
...
/** AVX256 **/
/*@
  context __P != NULL ** \pointer_length(__P) >= 8 ** (\forall* int i; 0<=i &&
i<8; Perm(__P[i], write)); ensures __P[0] == __A[0] && __P[1] == __A[1] &&
__P[2] == __A[2] && __P[3] == __A[3] &&
    __P[4] == __A[4] && __P[5] == __A[5] && __P[6] == __A[6] && __P[7] ==
__A[7];
@*/
...
/*@
  context __P != NULL ** \pointer_length((long long *)__P) >= 4 ** (\forall* int
i; 0<=i && i<4; Perm(((long long *)__P)[i], write)); ensures ((long long *)
__P)[0] == __A[0] && ((long long *) __P)[1] == __A[1] && ((long long *) __P)[2]
== __A[2] && ((long long *) __P)[3] == __A[3];
@*/
...
// SSE2
// __m128
/*@ pure @*/ __m128 _mm_add_ps(__m128 __A, __m128 __B) { return __A + __B; }

/*@ pure */ __m128 _mm_div_ps(__m128 __A, __m128 __B) { return __A / __B; }

/*@ pure @*/ __m128 _mm_mul_ps(__m128 __A, __m128 __B) { return __A * __B; }

/*@ pure @*/ __m128 _mm_sub_ps(__m128 __A, __m128 __B) { return __A - __B; }

// __m128d
/*@ pure @*/ __m128d _mm_add_pd(__m128d __A, __m128d __B) { return __A + __B; }

/*@ pure */ __m128d _mm_div_pd(__m128d __A, __m128d __B) { return __A / __B; }

/*@ pure @*/ __m128d _mm_mul_pd(__m128d __A, __m128d __B) { return __A * __B; }

/*@ pure @*/ __m128d _mm_sub_pd(__m128d __A, __m128d __B) { return __A - __B; }
...
// AVX2
// __m256
/*@ pure @*/ __m256 _mm256_add_ps(__m256 __A, __m256 __B) { return __A + __B; }

/*@ pure */ __m256 _mm256_div_ps(__m256 __A, __m256 __B) { return __A / __B; }

/*@ pure @*/ __m256 _mm256_mul_ps(__m256 __A, __m256 __B) { return __A * __B; }

/*@ pure @*/ __m256 _mm256_sub_ps(__m256 __A, __m256 __B) { return __A - __B; }
